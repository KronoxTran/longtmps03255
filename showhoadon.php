...
<html>
	...
	<body>
		...
		echo "<table>";
		echo "<tr>";
		echo "<th style='width:200px; border:1px solid;'>Ma Hoa Don</th>";
		echo "<th style='width:200px; border:1px solid;'>Ngay Mua</th>";
		echo "<th style='width:200px; border:1px solid;'>Ma Khach Hang</th>";
		echo "</tr>";
		//Loop through and echo all the records
		while ($row = $result->fetch_assoc()){
		echo "<tr>";
		echo "<td style='width:200px; border:1px solid;text-align:center;'>" . $row['MaHD'] . "</td>";
		echo "<td style='width:200px; border:1px solid;text-align:center;'>" . $row['NgayMua'] . "</td>";
